...
# Planned Sensor Output Fields as of April 30, 2017
 ...
 do_field_check channel Channel ChannelBusyExtTime			R2
 ...
 do_field_check scan Scan ChannelUtil					F
 ...
 do_field_check scan Scan StationCnt					F
 ...
 do_field_check station Station IPv4Address				F
 ...
 do_field_check station Station StationName				F
 ...
 do_field_check station Station TxRetries				R2
 ...
 do_field_check phycapa PhyCapa APName					R3
 do_field_check phycapa PhyCapa APMACAddress				R3
 do_field_check phycapa PhyCapa APIfIndex				R3
 do_field_check phycapa PhyCapa CurrentUTCTime				R3
 do_field_check phycapa PhyCapa Frequency			R3
 do_field_check phycapa PhyCapa ChannelNumber		R3
 do_field_check phycapa PhyCapa MaxTxPower			R3
 do_field_check phycapa PhyCapa ChannelWidth		R3
 do_field_check phycapa PhyCapa MCS			R3
 do_field_check phycapa PhyCapa MCS			R3
 do_field_check phycapa PhyCapa MCS			R3
 do_field_check phycapa PhyCapa VHTShortGI				R3
 do_field_check phycapa PhyCapa HTMCS					R3
 do_field_check event Event EventTime					R3
 do_field_check event Event EventType					R3
 do_field_check event Event APMACAddress				R3
 do_field_check event Event CurrentUTCTime				R3
 do_field_check event Event STAMAC			R3
 do_field_check event Event ConnectFrequency		R3
 do_field_check event Event ConnectChannelNumber	R3
 do_field_check event Event ConnectMode			R3
 do_field_check event Event ConnectSignal		R3
 do_field_check event Event SupportedBitrate		R3
